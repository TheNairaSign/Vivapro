...
class MessageRepository {
  ...
  Future<Either<MessageFailure, Unit>> initialiseMessage() async {
    try {
      ...
      developer.log('Error initialising message: $e',
          name: 'MessageRepository', error: e, stackTrace: s);
      return left(
  ...
  Future<Either<MessageFailure, String?>> getFcmToken() async {
    try {
      ...
      developer.log('Error getting FCM token: $e',
          name: 'MessageRepository', error: e, stackTrace: s);
      return left(MessageFailure('Error getting FCM token', error: e, stackTrace: s));
    }
  }
  ...
  Either<MessageFailure, Unit> tokenChangeListener() {
    try {
      ...
      developer.log('Error setting up FCM token listener: $e',
          name: 'MessageRepository', error: e, stackTrace: s);
      return left(
          MessageFailure('Error setting up FCM token listener', error: e, stackTrace: s));
    }
  }
  ...
  Future<Either<MessageFailure, Unit>> sendFCMToken(String? token) async {
    try {
      ...
      developer.log('Error sending FCM token: $e', name: 'MessageRepository', error: e, stackTrace: s);
      return left(MessageFailure('Error sending FCM token', error: e, stackTrace: s));
    }
  }
  ...
  Future<Either<MessageFailure, Unit>> markMessageAsSeen({
    ...
    try {
      ...
      developer.log('Error marking message as seen: $e', name: 'MessageRepository', error: e, stackTrace: s);
      return left(MessageFailure('Error marking message as seen', error: e, stackTrace: s));
    }
  }
  ...
  Future<Either<MessageFailure, List<Message>>> getMessages({
    ...
    try {
      ...
      developer.log('Error getting messages: $e', name: 'MessageRepository', error: e, stackTrace: s);
  ...
  Future<Either<MessageFailure, Unit>> markAsSeen(
    ...
    try {
      ...
      if (uid == null || uid.isEmpty) {
        return left(MessageFailure('User not authenticated to mark message as seen'));
      }
  ...
  Future<Either<MessageFailure, Unit>> deleteMessage({required String chatId, required String messageId}) async {
    try {
      await FirebaseFirestore.instance
          .collection('chats')
          .doc(chatId)
      ...
      developer.log('Error deleting message: $e', name: 'MessageRepository', error: e, stackTrace: s);
      return left(MessageFailure('Error deleting message', error: e, stackTrace: s));
    }
  }
}
