...
import 'package:vivapro/features/messaging/presentation/bloc/message_event.dart';
import 'package:vivapro/features/messaging/presentation/bloc/message_state.dart';
...
class MessageBloc extends Bloc<MessageEvent, MessageState> {
  ...
  Future<void> listenForMessage(
    ...
    await emit.forEach<List<Message>>(
      ...
      onError: (error, stackTrace) =>
          MessageStreamFailure(error.toString(), stackTrace),
    );
  }
  ...
  Future<void> sendMessage(
    ...
    try {
      final send = await messageRepository.sendMessage(
        chatId: event.chatId,
        text: event.text,
      );
      emit(
  ...
  Future<void> deleteMessage(
    ...
    try {
      final delete = await messageRepository.deleteMessage(
        chatId: event.chatId,
