    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected ? _iconColor.withValues(alpha: 0.1) : Theme.of(context).scaffoldBackgroundColor,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: isSelected ? _iconColor.withValues(alpha: 0.1) : GlobalColors.containerColor(context),
